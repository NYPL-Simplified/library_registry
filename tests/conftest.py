...
@pytest.fixture
def places(db_session, create_test_place):
    ...
    get_one_or_create(db_session, PlaceAlias, place=test_places["new_york_city"], name="Manhattan")
    get_one_or_create(db_session, PlaceAlias, place=test_places["new_york_city"], name="Brooklyn")
    get_one_or_create(db_session, PlaceAlias, place=test_places["new_york_city"], name="New York")
    ...
    get_one_or_create(db_session, PlaceAlias, place=test_places["zip_11212"], name="Brooklyn")
...
@pytest.fixture
def libraries(db_session, create_test_library, places):
