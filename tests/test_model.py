...
class TestExternalIntegration(DatabaseTest):
    ...
    def setup(self):
        ...
        (self.external_integration, _) = create(
...
class TestValidation(DatabaseTest):
    ...
    def test_restart_validation(self):
        ...
        library = self._library()
        (link1, _) = library.set_hyperlink("rel", "mailto:me@library.org")
        email = link1.resource
        (link2, _) = library.set_hyperlink("rel", "http://library.org")
        http = link2.resource
    ...
    def test_mark_as_successful(self):
        ...
        (validation, _) = create(self._db, Validation)
